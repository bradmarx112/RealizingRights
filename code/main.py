...
def main(source_info: dict, write_file_path: str, verbose: bool, max_dist_runs: int, col_subject: str) -> None:
    global full_df
...
if __name__ == '__main__':
    ...
    main(source_info=source_info, write_file_path=write_file_path, 
        verbose=False, max_dist_runs=100, col_subject='Disability')
